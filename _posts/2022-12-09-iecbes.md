...
**Insight 1**: As we can observe from Figure 1, BioSig is the most attractive session, followed by IoT, BioImg, and BioIns. Might be because we overcame the pandemic, the session COVID-19 only has 2 accepted papers. 
